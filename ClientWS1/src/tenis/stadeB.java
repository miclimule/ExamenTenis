...
public class stadeB extends JPanel {
	...
	public stadeB(Joueur perso1, Joueur perso2, Ball ball) {
		this.j1 = perso1;
		this.j2 = perso2;
		this.ball = ball;
			...
			if (chekcball) {
				if(ball.dx==0) {
					if (ball.xRebons==0) {
						...
						ball.setDirection();
						chekcball = false;
						// A mettre dans le web service cote gauche
						if (ball.x>width) {
							faute = true;
							System.out.println("FAUTE du joueur2 " + j2.name + " la balle est sortie a droite du terrain");
							j1.point+=15;
						}
						else if (ball.x < (widthTerrain+100)/2) {
							faute = true;
							System.out.println("Faute du joueur1 " + j1.name + " la balle est encore a gauche");
							j2.point+=15;
						}
						else if(ball.x < (width+xTerrain+10)/2 && ball.x > (width+xTerrain-10)/2) {
							faute = true;
							System.out.println("Faute du joueur1 " + j1.name + " la balle a touche les filets");
							j2.point+=15;
						}
						...
						if (ball.x>width) {
							faute = true;
							System.out.println("FAUTE du joueur1 " + j1.name + " la balle est sortie a droite du terrain");
							j2.point+=15;
						}
						else if (ball.x < (widthTerrain+100)/2) {
							faute = true;
				...
				if (ball.y < 30 || ball.y > height+50) {
					if (ball.xRebons == 0) {
						faute = true;
						System.out.println("Faute du joueur2 " + j2.name + " la balle est sortie du terrain , n'a pas ratrapper la balle");
						j1.point+=15;
					}
					else {
						faute = true;
				...
				if(ball.dx==0) {
					if (ball.xRebons==0) {
						...
						ball.setDirection();
						chekcball = true;
						// A mettre dans le web service cote droite
						if (ball.x<100) {
							faute = true;
							System.out.println("FAUTE du joueur1 " + j1.name + " la balle est sortie a gauche du terrain");
							j2.point+=15;
						}
						else if (ball.x > (widthTerrain+100)/2) {
							faute = true;
							System.out.println(ball.x +" > "+(widthTerrain+100)/2);
							System.out.println("Faute du joueur2 " + j2.name + " la balle est encore a droite");
							j1.point+=15;
						}
						else if(ball.x < (width+xTerrain+10)/2 && ball.x > (width+xTerrain-10)/2) {
							faute = true;
							System.out.println("Faute du joueur2 " + j2.name + " la balle a touche les filets");
							j1.point+=15;
						}
						System.out.println(ball.x);
						System.out.println(ball.dy);
						...
						if (ball.x<100) {
							faute = true;
							System.out.println("FAUTE du joueur2 " + j2.name + " la balle est sortie a gauche du terrain");
							j1.point+=15;
						}
						else if (ball.x > (widthTerrain+100)/2) {
							faute = true;
